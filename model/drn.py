...
class H2A2SR(nn.Module):
    def __init__(self, opt, num_channels=3, conv=common.default_conv):
        ...
        self.RCAB2 = common.RCAB(conv, 32, kernel_size, act=act)
        self.RCAB3 = common.RCAB(conv, 32, kernel_size, act=act)
        self.conv0 = nn.Conv2d(3, 32, kernel_size, padding=1)
        self.conv1 = nn.Conv2d(64, 32, kernel_size, padding=1)
        self.conv2 = nn.Conv2d(64, 32, kernel_size, padding=1)
        self.conv3 = nn.Conv2d(64, 32, kernel_size, padding=1)
        self.conv4 = nn.Conv2d(32, 3, kernel_size, padding=1)
